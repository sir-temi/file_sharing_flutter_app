...
class _UploadFileScreenState extends State<UploadFileScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final response = await Provider.of<Files>(context, listen: false).uploadFile(data, file, pt.basename(file!.path));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          actions: [BackButton(onPressed: () => Navigator.of(context).pushNamedAndRemoveUntil('/dashboard', (Route<dynamic> route) => false))]),
        ...
        onTap: () => FocusScope.of(context).unfocus(),
            ...
            child: Container(
                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        ...
                        child: 
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.attach_file_sharp, color: Colors.white, size: fontSize *30,), SizedBox(width: 10,), Text('Select File', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: fontSize * 20))],),
              ...
              builder: (ctx) => SimpleDialog(
                ...
                children: <Widget>[
                  SimpleDialogOption(
                    onPressed: _selectFileWithPicker
                      ,
                    child: Row(
                      children: [
                        Container(
                  ...
                  SimpleDialogOption(
                    onPressed: _selectFromMicrophone,
                    child: Row(
                      children: [
                        Container(
                          width: screensize.width * .08, 
                          alignment: Alignment.center,
                          child: FaIcon(FontAwesomeIcons.microphone, color: Theme.of(context).primaryColor, size: fontSize * 25)),
                        SizedBox(width: 5,),
                        Text(' Microphone', style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: fontSize * 18,
                        ),
                        )
                    ...
                    file == null
                    ? Text('')
                    : Text(pt.basename(file!.path), textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold),),
                    SizedBox(height: 10,),
                    Container(
                      child: TextFormField(
                        maxLength: 20,
                        ...
                        children: <Widget>[
                          Expanded(
                            child: RaisedButton(
                                ...
                                child: 
                                  // ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.share_rounded, color: Colors.white, size: fontSize *30,), SizedBox(width: 10,), Text('Send to ${data['username']}', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: fontSize * 20))],) 
                                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.cloud_upload_rounded, color: Colors.white, size: fontSize *30,), SizedBox(width: 10,), Text('Upload File', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: fontSize * 20))],),
